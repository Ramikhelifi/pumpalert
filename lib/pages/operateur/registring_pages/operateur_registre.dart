...
class operateur_registre extends StatelessWidget {
  operateur_registre({this.userId, this.email, this.password});
  ...
  Widget build(BuildContext context) {
    CollectionReference userggs =
        FirebaseFirestore.instance.collection('userggs');
    return Scaffold(
      body: ListView(
        children: [
          Image.asset(
            ...
            child: Column(
              ...
              children: [
                customelevatedbutton(
                    onPressed: () async {
                      try {
                        Navigator.pushNamed(context, 'operatorbottombar');
